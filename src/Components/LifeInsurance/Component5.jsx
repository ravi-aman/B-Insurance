    ...
    <div className="bg-white pt-10 md:pt-20 p-5 md:p-40">
      <div className="m-auto flex flex-col justify-center">
        <div className="flex flex-col md:flex-row justify-center items-center gap-10">
          <div className="w-full md:w-1/2 flex flex-col text-sm gap-5 md:gap-10 md:text-lg">
            ...
            <div className="pt-2 pb-2 rounded-lg text-sm text-center text-white bg-[#24BBE3] w-[40%] md:w-[30%]">
              Get a Quote
            </div>
          </div>
