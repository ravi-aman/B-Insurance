  ...
  return (
    <div className="bg-gradient-to-r from-[#0f6476] to-[#133e4e] flex flex-col md:flex-row items-center h-auto md:h-[40vh] justify-center px-5 md:px-10  ">
      ...
      <div className="text-white text-left pt-10 md:pt-0 md:pl-40 w-full">
        ...
        <p className="mt-4 text-[12px] md:text-sm text-start"> Getting commercial general liability insurance shouldn’t be complicated!
          At Zensurance, we simplify the process of getting insurance so that you get the coverage you need, quick and easy!</p>
